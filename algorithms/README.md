...
| 09 | [caching-strategy](09-caching-strategy.md) | Caching | LRU+TTL, ETag/304, preload cache, disk persistence | Known + Custom |
...
| 12 | [auth-and-rate-limiting](12-auth-and-rate-limiting.md) | Security | JWT parsing, refresh token rotation, sliding window rate limiter | Custom |
