...
from schemas import Envelope, AlbumOut, RATE_LIMITED
...
@router.get(
    ...
    summary="List albums",
    description="Return a paginated list of albums. Cached with ETag/Redis (60 s).",
...
@router.get(
    "/albums/{album_id}",
    response_model=Envelope[AlbumOut],
    summary="Get album",
    description="Return full album details including song IDs. Cached with ETag/Redis.",
    responses={**RATE_LIMITED},
)
